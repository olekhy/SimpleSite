...
class Configure
{
    ...
    */
    ...
    {
        if(self::isCachingOn() && self::getCacheManager()->hasCacheTemplate('file'))
        {                     
            $cache = self::getCacheManager()->getCache('file');
    ...
    public static function initCache()
    {
        ...
        self::getCacheManager()->setCacheTemplate('file', $cacheTemplate);
    }
